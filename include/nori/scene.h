...
public:
    ...
    const std::vector<Mesh *> &getEmittedMeshes() const { return m_emitted_meshses;  };

    Mesh* sampleEmittedLight(Sampler *sampler, float& pdf) const;
    /**
...
private:
    ...
    std::vector<Mesh*> m_emitted_meshses;
